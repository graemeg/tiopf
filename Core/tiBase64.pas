{
    This file originated from the Free Pascal Compiler project - part of
...
type
  ...
  public
    constructor Create(ASource: TStream); reintroduce; virtual;
...
begin
  ...
  if DecodedSize<>-1 then Exit{$IFDEF FPC}(DecodedSize){$ENDIF};
...
function TOwnerStream.GetPosition: Int64;
begin
