...
procedure TtiDatabaseRemoteXML.SetConnected(AValue: boolean);
  ...
  begin
    ...
    begin
      Log(cTIOPFExcMsgConnectionConfirmationFormatWrong, [TtiAppServerVersionAbs.ExpectedAsString, ls], lsError);
...
begin
  ...
  begin
    ...
    FHTTP.RetryLimit:= StrToIntDef(Params.Values[CHTTPRetryLimit], cRetryCount);
    FHTTP.RetryWaitMS:= StrToIntDef(Params.Values[CHTTPRetryWaitMS], cRetrySleep);
