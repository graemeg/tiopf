...
class procedure TtiDatabaseDatasnapSoap.CreateDatabase(const ADatabaseName, AUserName, APassword: string);
begin
  Assert(False, 'CreateDatabase not implemented in ' + ClassName);
end;

class function TtiDatabaseDatasnapSoap.DatabaseExists(const ADatabaseName, AUserName, APassword: string): Boolean;
begin
...
class procedure TtiDatabaseDatasnapSoap.DropDatabase(const ADatabaseName, AUserName, APassword: string);
begin
