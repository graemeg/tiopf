...
tiOPF Code Templates
--------------------

This is a directory where you will find tiOPF Code Templates for use with 
the Lazarus IDE.
...
2) Open the lazarus.dci file with you favourite editor. This is the file that
   ...
   the lararus.dci is normally in the following directories, but it my vary:
