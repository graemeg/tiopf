...
begin
  ...
  try gTIPerMgr.DropTable('EAdrs' ) except end ;
  try gTIPerMgr.DropTable('Person' ) except end ;
  try gTIPerMgr.DropTable('Company' ) except end ;
  try gTIPerMgr.DropTable('Lookup_List_Value' ) except end ;
  try gTIPerMgr.DropTable('Lookup_List_Name' ) except end ;
