...
//
// $Id: TBXLists.pas,v 1.28 2003/07/28 03:28:58 Alex Exp $
...
{  TTBXObjectListItem = class(TCollectionItem)
  private
    FCaption: string;
    FData: Pointer;
  ...
  TTBXILUpdateEvent = procedure(Sender: TCollection; Item: TTBXObjectListItem) of object;

  TTBXObjectListCollection = class(TOwnedCollection)
  private
    FOnUpdate: TTBXILUpdateEvent;
  protected
    procedure Update(Item: TCollectionItem); override;
    property FOnUpdate: TTBXILUpdateEvent read FOnUpdate write FOnUpdate;
  public
    constructor Create(AOwner: TPersistent);
    function Add: TTBXImageListCollectionItem;
    function Insert(Index: Integer): TTBXObjectListItem;
    property Items[Index: Integer]: TTBXObjectListItem read GetItem; default;
  end;        }
