...
const
  ...
  TMI_EDIT_MENUMIDWIDTH      = 64;
  TMI_EDIT_BTNWIDTH          = 65;

{ Boolean Metric IDs }
const
  TMB_OFFICEXPPOPUPALIGNMENT = 1;
  TMB_EDITCAPTIONINDENTED    = 3;
...
const
  ...
  ISF_PUSHED                 = $04;
  ISF_SELECTED               = $08;
  ISF_MENUCOLOR              = $10;  // for text and images painted in popups and DkPanels
...
type
  ...
  TTBXFontSize = (tbxfNormal, tbxfSmaller, tbxfLarger);
  TTBXMargins = record
    LeftWidth: Integer;
    RightWidth: Integer;
    TopHeight: Integer;
  ...
  public
    ...
    function  GetViewColor(AViewType: Integer): TColor; virtual; abstract;
    ...
    procedure PaintMenuItem(Canvas: TCanvas; var ARect: TRect; var ItemInfo: TTBXItemInfo); virtual; abstract;
    ...
    procedure PaintGlyph(Canvas: TCanvas; R: TRect; Kind, State: Integer); virtual; abstract;
    ...
    property MenuMarginVert: Integer index TMI_MENU_VMARGIN read GetIntegerMetrics;
    property MenuMarginHorz: Integer index TMI_MENU_HMARGIN read GetIntegerMetrics;
    ...
    property LineSpacing: Integer index TMI_LINE_SPACING read GetIntegerMetrics;
    ...
    property EditMenuMidWidth: Integer index TMI_EDIT_MENUMIDWIDTH read GetIntegerMetrics;
    ...
    property EditCaptionIndented: Boolean index TMB_EDITCAPTIONINDENTED read GetBooleanMetrics;
    ...
    property SolidToolbars: Boolean index TMB_SOLIDTOOLBARS read GetBooleanMetrics;
