...
{
 $Source: /usr/local/cvs/EPC/DelphiExperts/Common/XP_OTAWizards.pas,v $
 $Revision: 1.5 $
 $Date: 2004/03/26 13:08:17 $
...
const CVSID: string = '$Header: /usr/local/cvs/EPC/DelphiExperts/Common/XP_OTAWizards.pas,v 1.5 2004/03/26 13:08:17 paul Exp $';
