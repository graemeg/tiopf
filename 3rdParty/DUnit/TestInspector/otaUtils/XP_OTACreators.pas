...
{
 $Source: /usr/local/cvs/EPC/DelphiExperts/Common/XP_OTACreators.pas,v $
 $Revision: 1.7 $
 $Date: 2003/07/19 05:46:13 $
...
const CVSID: string = '$Header: /usr/local/cvs/EPC/DelphiExperts/Common/XP_OTACreators.pas,v 1.7 2003/07/19 05:46:13 paul Exp $';
