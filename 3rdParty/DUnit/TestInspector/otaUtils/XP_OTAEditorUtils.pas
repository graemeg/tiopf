...
{
 $Source: /usr/local/cvs/EPC/DelphiExperts/Common/XP_OTAEditorUtils.pas,v $
 $Revision: 1.6 $
 $Date: 2004/03/28 05:58:19 $
...
const
  CVSID: string = '$Header: /usr/local/cvs/EPC/DelphiExperts/Common/XP_OTAEditorUtils.pas,v 1.6 2004/03/28 05:58:19 paul Exp $';
