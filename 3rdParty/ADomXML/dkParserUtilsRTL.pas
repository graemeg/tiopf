unit dkParserUtilsRTL;

{$I ADOMXMLWarn.inc}

// dkParserUtilsRTL 3.0.4 -- .NET version
...
//
// The Original Code is "dkParserUtilsRTL.pas".
//
...
//                  modified.
//                  EncodingToStr, EncodingToWideStr, StrToEncoding functions removed.
...
begin
  Result := ConvertToUTF16(SourceEncoding, BytesOf(S));
end;

function ConvertFromUTF16(const TargetEncoding: string; const S: WideString): AnsiString;
var
  C : TUnicodeCodec;
  I : Integer;
begin
