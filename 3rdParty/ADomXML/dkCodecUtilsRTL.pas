...
// dkCodecUtilsRTL 1.0.0 -- .NET version
...
//                  fixes.
// 2009-02-23 1.0.0 First release of CodecUtilsRTL maintained by Dieter
...
{$IFNDEF ALL_OS}
    ...
    class function  CreateCodecForSystemEncoding: TUnicodeCodec; virtual; platform; // Does not work under Linux-Mono
    class function  SystemEncodingName: string; virtual; platform; // Does not work under Linux-Mono
{$ENDIF}
...
{                                                                              }
  ...
  protected
    class function EncodingInfo: TEncodingInfo; virtual;
...
type
  ...
  protected
    class function EncodingInfo: TEncodingInfo; override;
    procedure InternalReadUCS4Char(out C: UCS4Char;
...
begin
  if (I < 0) or (I >= Count) then
    raise ArgumentOutOfRangeException.Create('I');
...
begin
  ...
  then
    ...
    Result := EncodingInfo.AliasCount;
end;
...
{$IFDEF D8_D2005_D2006_ONLY}
      if System.String.Compare(S, Alias(I), True) = 0 then
{$ELSE}
      if System.String.Compare(S, Alias(I), StringComparison.OrdinalIgnoreCase) = 0 then
{$ENDIF}
        begin
          Result := I;
          Exit;
...
class function TUnicodeCodec.EncodingInfo: TEncodingInfo;
begin
  Result := nil;
end;
...
begin
  if EncodingInfo = nil
    then Result := 1
    else Result := EncodingInfo.MIBenum;
end;
...
begin
  if EncodingInfo = nil
    then Result := ''
    else Result := EncodingInfo.PreferredMIMEName;
end;
...
function TUnicodeCodec.DecodeBytes(const Bytes: TBytes): WideString;
var
...
function TUnicodeCodec.ReadBuffer(var Buf: array of Byte; Count: Integer): Boolean;
begin
  Result := False;
...
procedure TUnicodeCodec.WriteBuffer(const Buf: array of Byte; Count: Integer);
begin
...
class function TUTF8Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoUTF8.Create;
end;
...
{ UTF-8 encoding.                                                              }
function TUTF8Codec.UCS4CharToUTF8(const Ch: UCS4Char): TBytes;
begin
...
class function TUTF16BECodec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoUTF16BE.Create;
end;
...
function TUTF16BECodec.UCS4CharToUTF16BE(const Ch: UCS4Char): TBytes;
var
...
class function TUTF16LECodec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoUTF16LE.Create;
end;
...
{ UCS4CharToUTF16LE transforms the UCS4 char Ch to UTF-16LE encoding. The      }
{ resulting array is either 2 or 4 bytes long, depending on whether surrogat   }
{ pairs are used or not.                                                       }
function TUTF16LECodec.UCS4CharToUTF16LE(const Ch: UCS4Char): TBytes;
var
  C, HighSurrogate, LowSurrogate: TBytes;
begin
  case Ch of
...
class function TUCS4BECodec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoUCS4.Create;
end;
...
class function TUCS4LECodec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoUCS4.Create;
end;
...
class function TUCS4_2143Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoUCS4.Create;
end;
...
class function TUCS4_3412Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoUCS4.Create;
end;
...
class function TUCS2BECodec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoUCS2.Create;
end;
...
class function TUCS2LECodec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoUCS2.Create;
end;
...
{ ISO-8859-1 - Latin 1                                                         }
{                                                                              }
class function TISO8859_1Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoISOLatin1.Create;
end;
...
{ ISO-8859-2 Latin 2                                                           }
{                                                                              }
class function TISO8859_2Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoISOLatin2.Create;
end;
...
{ ISO-8859-3 - Latin 3                                                         }
{                                                                              }
class function TISO8859_3Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoISOLatin3.Create;
end;
...
{ ISO-8859-4 - Latin 4                                                         }
{                                                                              }
class function TISO8859_4Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoISOLatin4.Create;
end;
...
{ ISO-8859-5 - Cyrillic                                                        }
{                                                                              }
class function TISO8859_5Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIsoLatinCyrillic.Create;
end;
...
{ ISO-8859-6 - Arabic                                                          }
{                                                                              }
class function TISO8859_6Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIsoLatinArabic.Create;
end;
...
{                                                                              }
class function TISO8859_7Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIsoLatinGreek.Create;
end;
...
{ ISO-8859-8 - Hebrew                                                          }
{                                                                              }
class function TISO8859_8Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIsoLatinHebrew.Create;
end;
...
{ ISO-8859-9 - Latin 5                                                         }
{                                                                              }
class function TISO8859_9Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIsoLatin5.Create;
end;
...
{ ISO-8859-10 - Latin 6                                                        }
{                                                                              }
class function TISO8859_10Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIsoLatin6.Create;
end;
...
{ ISO-8859-13 - Latin 7                                                        }
{                                                                              }
class function TISO8859_13Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoISO885913.Create;
end;
...
{ ISO-8859-14 - Latin 8                                                        }
{                                                                              }
class function TISO8859_14Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIsoLatin8.Create;
end;
...
{ ISO-8859-15 - Latin 9                                                        }
{                                                                              }
class function TISO8859_15Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIsoLatin9.Create;
end;
...
{                                                                              }
class function TIBM037Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM037.Create;
end;
...
{ IBM038                                                                       }
{                                                                              }
class function TIBM038Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM038.Create;
end;
...
{ IBM273                                                                       }
{                                                                              }
class function TIBM273Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM273.Create;
end;
...
{ IBM274                                                                       }
{                                                                              }
class function TIBM274Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM274.Create;
end;
...
{ IBM275                                                                       }
{                                                                              }
class function TIBM275Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM275.Create;
end;
...
{ IBM277                                                                       }
{                                                                              }
class function TIBM277Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM277.Create;
end;
...
{ IBM278                                                                       }
{                                                                              }
class function TIBM278Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM278.Create;
end;
...
{ IBM280                                                                       }
{                                                                              }
class function TIBM280Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM280.Create;
end;
...
{   Similar to IBM038.                                                         }
{                                                                              }
class function TIBM281Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM281.Create;
end;
...
{ IBM284                                                                       }
{                                                                              }
class function TIBM284Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM284.Create;
end;
...
{ IBM285                                                                       }
{                                                                              }
class function TIBM285Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM285.Create;
end;
...
{ IBM290                                                                       }
{                                                                              }
class function TIBM290Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM290.Create;
end;
...
{ IBM297                                                                       }
{                                                                              }
class function TIBM297Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM297.Create;
end;
...
{ IBM420                                                                       }
{                                                                              }
class function TIBM420Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM420.Create;
end;
...
{ IBM423                                                                       }
{                                                                              }
class function TIBM423Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM423.Create;
end;
...
{ IBM424                                                                       }
{                                                                              }
class function TIBM424Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM424.Create;
end;
...
{                                                                              }
class function TIBM437Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoPC8CodePage437.Create;
end;
...
{                                                                              }
class function TIBM500Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM500.Create;
end;
...
{                                                                              }
class function TIBM850Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoPC850Multilingual.Create;
end;
...
{ IBM851                                                                       }
{                                                                              }
class function TIBM851Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM851.Create;
end;
...
{                                                                              }
class function TIBM852Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoPCp852.Create;
end;
...
{                                                                              }
class function TIBM855Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM855.Create;
end;
...
{                                                                              }
class function TIBM857Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM857.Create;
end;
...
{ IBM860                                                                       }
{                                                                              }
class function TIBM860Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM860.Create;
end;
...
{                                                                              }
class function TIBM861Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM861.Create;
end;
...
{                                                                              }
class function TIBM862Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoPC862LatinHebrew.Create;
end;
...
{                                                                              }
class function TIBM863Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM863.Create;
end;
...
{ IBM864                                                                       }
{                                                                              }
class function TIBM864Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM864.Create;
end;
...
{                                                                              }
class function TIBM865Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM865.Create;
end;
...
{                                                                              }
class function TIBM866Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM866.Create;
end;
...
{ IBM868                                                                       }
{                                                                              }
class function TIBM868Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM868.Create;
end;
...
{ IBM869                                                                       }
{                                                                              }
class function TIBM869Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM869.Create;
end;
...
{ IBM870                                                                       }
{                                                                              }
class function TIBM870Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM870.Create;
end;
...
{ IBM871                                                                       }
{                                                                              }
class function TIBM871Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM871.Create;
end;
...
{ IBM880                                                                       }
{                                                                              }
class function TIBM880Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM880.Create;
end;
...
{ IBM904                                                                       }
{                                                                              }
class function TIBM904Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM904.Create;
end;
...
{ IBM905                                                                       }
{                                                                              }
class function TIBM905Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM905.Create;
end;
...
{ IBM918                                                                       }
{                                                                              }
class function TIBM918Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM918.Create;
end;
...
{ IBM1026                                                                      }
{                                                                              }
class function TIBM1026Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM1026.Create;
end;
...
{ IBM1047                                                                      }
{                                                                              }
class function TIBM1047Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoIBM1047.Create;
end;
...
{ Windows-1250                                                                 }
{                                                                              }
class function TWindows1250Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoWindows1250.Create;
end;
...
{ Windows-1251                                                                 }
{                                                                              }
class function TWindows1251Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoWindows1251.Create;
end;
...
{ Windows-1252                                                                 }
{                                                                              }
class function TWindows1252Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoWindows1252.Create;
end;
...
{ Windows-1253                                                                 }
{                                                                              }
class function TWindows1253Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoWindows1253.Create;
end;
...
{ Windows-1254                                                                 }
{                                                                              }
class function TWindows1254Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoWindows1254.Create;
end;
...
{ Windows-1255                                                                 }
{                                                                              }
class function TWindows1255Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoWindows1255.Create;
end;
...
{ Windows-1256                                                                 }
{                                                                              }
class function TWindows1256Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoWindows1256.Create;
end;
...
{ Windows-1257                                                                 }
{                                                                              }
class function TWindows1257Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoWindows1257.Create;
end;
...
{ Windows-1258                                                                 }
{                                                                              }
class function TWindows1258Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoWindows1258.Create;
end;
...
{ US-ASCII                                                                     }
{                                                                              }
class function TUSASCIICodec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoAscii.Create;
end;
...
{ EBCDIC-US                                                                    }
{                                                                              }
class function TEBCDIC_USCodec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoEBCDICUS.Create;
end;
...
{ KOI8-R                                                                       }
{                                                                              }
class function TKOI8_RCodec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoKOI8R.Create;
end;
...
{ JIS_X0201                                                                    }
{                                                                              }
class function TJIS_X0201Codec.EncodingInfo: TEncodingInfo;
begin
  Result := TEncodingInfoHalfWidthKatakana.Create;
end;
