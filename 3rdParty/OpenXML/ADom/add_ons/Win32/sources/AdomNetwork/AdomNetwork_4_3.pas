...
//
// The Original Code is "AdomNetwork_4_3.pas".
//
...
uses
  IdHTTP, IdHTTPHeaderInfo, IdCookieManager,
    ...
    // Direct (Indy) 10.0.52 package available at "http://www.indyproject.org".
{$IFDEF VER210}
  dkAdomCore_4_3,
{$ELSE}
  AdomCore_4_3,
{$ENDIF}
  dkUriUtils, dkWideStringUtils, Classes, SysUtils;
