...
//
// The Original Code is "AdomErrorReporting_4_3.pas".
//
...
{$ELSE}
  AdomCore_4_3,
{$ENDIF}
  dkLangUtils, dkCodecUtilsWin32, AutoListUtils, SysUtils, Classes;
...
begin
  ...
  begin
    I := LastDelimiter(WideString('/'), Uri);
  ...
  begin
    ...
    case RelatedException of
      ...
      ET_UNPARSED_ENTITY_REFERENCED_IN_ENTITY_DECLARATION:
        ErrorStr := 'ET_UNPARSED_ENTITY_REFERENCED_IN_ENTITY_DECLARATION';
      ET_XML_SPACE_ATTRIBUTE_ERRONEOUS_VALUE_DECLARED:
        ErrorStr := 'ET_XML_SPACE_ATTRIBUTE_ERRONEOUS_VALUE_DECLARED';
      ET_XML_SPACE_ATTRIBUTE_ERRONEOUS_VALUE_SPECIFIED:
        ErrorStr := 'ET_XML_SPACE_ATTRIBUTE_ERRONEOUS_VALUE_SPECIFIED';
      ET_XML_SPACE_ATTRIBUTE_NOT_ENUMERATED_TYPE:
        ErrorStr := 'ET_XML_SPACE_ATTRIBUTE_NOT_ENUMERATED_TYPE';
...
begin
  ...
  begin
    ...
    case RelatedException of
      ...
      ET_UNPARSED_ENTITY_REFERENCED_IN_ENTITY_DECLARATION:
        ErrorStr := 'Reference to unparsed entity in entity declaration';
      ET_XML_SPACE_ATTRIBUTE_ERRONEOUS_VALUE_DECLARED:
        ErrorStr := 'Erroneous value declared for xml:space attribute. Only "default" and "preserve" are allowed.';
      ET_XML_SPACE_ATTRIBUTE_ERRONEOUS_VALUE_SPECIFIED:
        ErrorStr := 'Erroneous value specified for xml:space attribute. Only "default" and "preserve" are allowed.';
      ET_XML_SPACE_ATTRIBUTE_NOT_ENUMERATED_TYPE:
        ErrorStr := 'An xml:space attribute must be declared as an enumerated type.';
      ET_UNDEFINED_ATTRIBUTE:
...
begin
  ...
  begin
    ...
    case RelatedException of
      ...
      ET_UNPARSED_ENTITY_REFERENCED_IN_ENTITY_DECLARATION:
        ErrorStr := 'Verweis auf eine nicht analysierbare Entität in einer Entitäten-Deklaration';
      ET_XML_SPACE_ATTRIBUTE_ERRONEOUS_VALUE_DECLARED:
        ErrorStr := 'Deklarierter Wert für ein xml:space Attribut ist fehlerhaft. Erlaubt sind nur "default" and "preserve".';
      ET_XML_SPACE_ATTRIBUTE_ERRONEOUS_VALUE_SPECIFIED:
        ErrorStr := 'Angegebener Wert für ein xml:space Attribut ist fehlerhaft. Erlaubt sind nur "default" and "preserve".';
      ET_XML_SPACE_ATTRIBUTE_NOT_ENUMERATED_TYPE:
        ErrorStr := 'Ein xml:space Attribut muß als Aufzählungstyp deklariert werden.';
      ET_UNDEFINED_ATTRIBUTE:
        ErrorStr := 'Attribut nicht definiert';
      ET_REQUIRED_ATTRIBUTE_NOT_SPECIFIED:
        ErrorStr := 'Als "#REQUIRED" deklariertes Attribut fehlt';
      ET_FIXED_ATTRIBUTE_MISMATCH:
        ErrorStr := 'Werte eines als "#FIXED" deklarierten Attributs entspricht nicht der Deklaration';
      ET_FRAGMENT_IDENTIFIER_IN_SYSTEM_IDENTIFIER:
