Patching ADOM in Delphi 2010
============================

Delphi 2010 natively includes the Open XML Utilities library and a runtime version of ADOM 4.3. Completely replacing this units and packages is tricky and error-prone. Thus I recommend one of the following methods to use the ADOM update side by side with the one that is already installed in Delphi 2010. 
