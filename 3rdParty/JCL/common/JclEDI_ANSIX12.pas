...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jcl.svn.sourceforge.net:443/svnroot/jcl/tags/JCL-2.1-Build3536/jcl/source/common/JclEDI_ANSIX12.pas $';
...
begin
  ...
  if Copy(FData, SearchResult + 1, 2) = NativeCrLf then
