...
type
  ...
  private
    ...
    procedure SetOnCanEdit(const Value: TtiLogicalEvent);
  protected
    ...
    procedure   SetOnView(const Value: TNotifyEvent);virtual ; abstract ;
    procedure   SetOnDelete(const Value: TNotifyEvent);virtual ; abstract ;
    procedure   SetOnEdit(const Value: TNotifyEvent);virtual ; abstract ;
    procedure   SetOnNew(const Value: TNotifyEvent);virtual ; abstract ;
  public
  ...
  protected
    ...
    procedure   SetOnView(const Value: TNotifyEvent); override ;
    procedure   SetOnDelete(const Value: TNotifyEvent); override ;
    procedure   SetOnEdit(const Value: TNotifyEvent); override ;
    procedure   SetOnNew(const Value: TNotifyEvent); override ;
  public
    constructor Create( Owner : TComponent ) ; override ;
...
procedure TtiCtrlBtnPnlAbs.SetOnCanEdit(const Value: TtiLogicalEvent);
begin
  FOnCanEdit := Value;
end;
...
procedure TtiCtrlBtnPnlButton.SetOnDelete(const Value: TNotifyEvent);
begin
  FBtnDelete.OnClick := Value;
end;

procedure TtiCtrlBtnPnlButton.SetOnEdit(const Value: TNotifyEvent);
begin
  FBtnEdit.OnClick := Value;
end;

procedure TtiCtrlBtnPnlButton.SetOnNew(const Value: TNotifyEvent);
begin
  FBtnNew.OnClick := Value;
end;

procedure TtiCtrlBtnPnlButton.SetOnView(const Value: TNotifyEvent);
begin
  FBtnView.OnClick := Value;
end;
