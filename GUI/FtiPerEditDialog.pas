...
//    function  FormIsValid : boolean ; override ;
  ...
  public
    ...
    class function Execute( const pData : TtiObject ; pReadOnly : boolean = false ) : boolean ; virtual ;
  end;
...
class function TFormTIPerEditDialog.Execute( const pData: TtiObject ; pReadOnly : boolean = false ): boolean;
var
...
procedure TFormTIPerEditDialog.SetData(const Value: TtiObject);
begin
  FData := Value;
