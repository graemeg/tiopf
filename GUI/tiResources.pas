...
const
  ...
  cResTI_FindNext                = 'ti_FindNext';
  cResTI_FindNext16D             = cResTI_FindNext + cResTI_16D;
  cResTI_FindNext16H             = cResTI_FindNext + cResTI_16H;
  cResTI_FindNext16N             = cResTI_FindNext + cResTI_16N;
  cResTI_FindPrevious            = 'ti_FindPrevious';
  cResTI_FindPrevious16D         = cResTI_FindPrevious + cResTI_16D;
  cResTI_FindPrevious16H         = cResTI_FindPrevious + cResTI_16H;
  cResTI_FindPrevious16N         = cResTI_FindPrevious + cResTI_16N;
  ...
  cResTI_NetworkTraffic          = 'ti_NetworkTraffic';
  cResTI_NetworkTrafficD         = 'ti_NetworkTraffic_16D';
  cResTI_NetworkTrafficN         = 'ti_NetworkTraffic_16N';
