...
type
  TFormMain = class(TForm)
    ...
    procedure LVItemDelete(pLV: TtiCustomListView; pData: TtiObject;
      pItem: TListItem);
    procedure LVItemEdit(pLV: TtiCustomListView; pData: TtiObject;
      pItem: TListItem);
    procedure LVItemInsert(pLV: TtiCustomListView; pData: TtiObject;
      pItem: TListItem);
...
procedure TFormMain.LVItemEdit(pLV: TtiCustomListView; pData: TtiObject;  pItem: TListItem);
var
  lData : TtiObject;
begin
  lData := TtiObject pData ) ;
  if lData is TtiFileSyncDir then
    ...
    raise Exception.create( 'Invalid class type passed' ) ;
end;
...
begin
  ...
  begin
    ...
    raise Exception.create( 'Invalid PC.ActivePage' ) ;

end;

procedure TFormMain.LVFilterData(pData: TtiObject; var pbInclude: Boolean);
begin
