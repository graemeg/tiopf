...
type
  TFormTIDeployChild_App = class(TForm)
    ...
    procedure LVFilesFilterData(pData: TtiObject; var pbInclude: Boolean);
    procedure LVFilesGetFont(pLV: TtiCustomListView; pCanvas: TCanvas;
      pItem: TListItem; pData: TtiObject);
    procedure LVFilesGetImageIndex(pData: TtiObject;
      var pImageIndex: Integer);
    procedure LVFilesItemDelete(pLV: TtiCustomListView; pData: TtiObject;
      pItem: TListItem);
    procedure LVFilesItemEdit(pLV: TtiCustomListView; pData: TtiObject;
      pItem: TListItem);
    procedure LVFilesItemInsert(pLV: TtiCustomListView; pData: TtiObject;
      pItem: TListItem);
    ...
    procedure LVParamsItemEdit(pLV: TtiCustomListView;
      pData: TtiObject; pItem: TListItem);
    procedure LVParamsItemInsert(pLV: TtiCustomListView;
      pData: TtiObject; pItem: TListItem);
    procedure PCChange(Sender: TObject);
    procedure sbSaveOneClick(Sender: TObject);
    procedure LVFilesItemArive(pLV: TtiCustomListView; pData: TtiObject;
      pItem: TListItem);
    procedure LVFilesItemLeave(pLV: TtiCustomListView; pData: TtiObject;
      pItem: TListItem);
  private
    FData: TtiDeployApp;
    FTreeNode: TTreeNode;
...
procedure TFormTIDeployChild_App.LVFilesFilterData(pData: TtiObject;
...
procedure TFormTIDeployChild_App.LVFilesGetImageIndex(pData: TtiObject;
  var pImageIndex: Integer);
begin
  if pData = nil then
    Exit ; //==>
...
begin
  ...
  gTIOPFManager.VisitorManager.Execute( cgsDeployMgrSave, lFile ) ;
