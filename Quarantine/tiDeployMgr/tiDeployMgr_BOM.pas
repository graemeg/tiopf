...
type
  ...
  TtiDeployApps  = class( TtiObjectList )
  private
  ...
  TtiDeployParams = class( TtiObjectList )
  protected
  ...
  TtiDeployParam = class( TtiObject )
  private
    FParamStr: string;
    FDisplayText: string;
    FDescription: string;
  ...
  public
    ...
    //procedure   Assign( pSource : TtiObject ) ; reintroduce ;
  published
  ...
  TtiDeployApp = class( TtiObjectList )
  private
    FAppName : string ;
    FDescription : string ;
  ...
  public
    ...
    property  Owner : TtiDeployApp read GetOwner write SetOwner ;
    function  Equals( pData : TtiObject ) : boolean ; override ;
  end ;

  TtiDeployLaunchApps = class( TtiObjectList )
  private
  protected
  ...
  TtiDeployLaunchApp  = class( TtiObject )
  private
...
function TtiDeployFile.Equals(pData: TtiObject): boolean;
var
  lData : TtiDeployFile ;
begin
