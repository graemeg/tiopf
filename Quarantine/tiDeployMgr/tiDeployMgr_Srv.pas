...
begin
  ...
  begin
    ...
    TtiObjectList( Visited ).Add( FLastDeployApp ) ;
  end ;
end;
...
begin
  ...
  try
    ...
    Log( 'Compressed size: %f%%', [ lrCompRatio ]) ;
  finally
    lComp.Free ;
  end ;
...
initialization
  ...
  gTIOPFManager.VisitorManager.RegisterVisitor( cgsDeployMgrReadPK,    TVisDeployMgrReadPK ) ;

  // Read all by group
  // gVisMgr.RegisterVisitor( cgsDeployMgrReadApp,   TVisDeployMgrFilesReadByAppName ) ;

  gTIOPFManager.VisitorManager.RegisterVisitor( cgsDeployMgrReadAppDetails, TVisDeployMgrReadOID ) ;
  gTIOPFManager.VisitorManager.RegisterVisitor( cgsDeployMgrReadAppDetails, TVisDeployMgrParamsRead ) ;
  gTIOPFManager.VisitorManager.RegisterVisitor( cgsDeployMgrReadAppDetails, TVisDeployMgrFilesReadByOID ) ;

  // Download a file which is out of date
  gTIOPFManager.VisitorManager.RegisterVisitor( cgsDeployMgrReadBin, TVisDeployMgrReadBin ) ;
//  gVisMgr.RegisterVisitor( cgsDeployMgrLaunch,   TDeployMgrLaunch ) ;

  gTIOPFManager.VisitorManager.RegisterVisitor( cgsDeployMgrSave,      TVisDeployMgrParamsDelete ) ;
  gTIOPFManager.VisitorManager.RegisterVisitor( cgsDeployMgrSave,      TVisDeployMgrFileDelete ) ;
  gTIOPFManager.VisitorManager.RegisterVisitor( cgsDeployMgrSave,      TVisDeployMgrAppDelete ) ;

  gTIOPFManager.VisitorManager.RegisterVisitor( cgsDeployMgrSave,      TVisDeployMgrAppCreate ) ;
  gTIOPFManager.VisitorManager.RegisterVisitor( cgsDeployMgrSave,      TVisDeployMgrFileCreate ) ;
  gTIOPFManager.VisitorManager.RegisterVisitor( cgsDeployMgrSave,      TVisDeployMgrParamsCreate ) ;

  gTIOPFManager.VisitorManager.RegisterVisitor( cgsDeployMgrSave,      TVisDeployMgrAppUpdate ) ;
  gTIOPFManager.VisitorManager.RegisterVisitor( cgsDeployMgrSave,      TVisDeployMgrParamsUpdate ) ;
