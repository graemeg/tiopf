...
uses
  ...
  FtiPerEditDialog, tiObject, ExtCtrls,
  StdCtrls, Buttons, tiObject, tiPerAwareFileCombos, tiReadOnly,
  tiFocusPanel, tiPerAwareCtrls, tiPerAwareDirectoryCombos,
  tiPerAwareCombosAbs;
...
procedure TFormEditFile.SetData(const Value: TtiObject);
begin
