...
procedure TtiDatabaseBDEParadox.ReadMetaDataFields(pData: TPersistent);
var
...
procedure TtiDatabaseBDEParadox.ReadMetaDataTables(pData: TPersistent);
var
...
Initialization
  gtiPerMgr.RegPerLayers.__RegisterPersistenceLayer(
              ...
              TtiDatabaseBDEParadox ) ;
finalization
  gtiPerMgr.RegPerLayers.__UnRegisterPersistenceLayer( cTIPersistBDEParadox ) ;
