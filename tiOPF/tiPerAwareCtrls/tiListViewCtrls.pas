...
type
  ...
  TtiLVLBGetCheckedEvent  = procedure( pData : TPersistent ; var pbChecked : boolean ) of object ;
  ...
  private
    ...
    procedure DoOnGetImageIndex( pData : TPersistent ; var ImageIndex : integer ) ;
    ...
    function  GetIsSelected(pData: TPersistent): boolean;
  protected
...
const
  ...
  // Could do this better with a set & type...
  cusCheckBoxChecked              = 'CheckBoxChecked' ;
  cusCheckBoxUnChecked            = 'CheckBoxUnChecked' ;
  cusRadioButtonChecked           = 'RadioButtonChecked' ;
  cusRadioButtonUnChecked         = 'RadioButtonUnChecked' ;
  cusCheckBoxCheckedDisabled      = 'CheckBoxCheckedDisabled' ;
  cusCheckBoxUnCheckedDisabled    = 'CheckBoxUnCheckedDisabled' ;
  cusRadioButtonCheckedDisabled   = 'RadioButtonCheckedDisabled' ;
  cusRadioButtonUnCheckedDisabled = 'RadioButtonUnCheckedDisabled' ;
...
begin
  ...
  begin
    LoadImage( cusCheckBoxChecked      ) ;
    LoadImage( cusCheckBoxUnChecked    ) ;
    LoadImage( cusRadioButtonChecked   ) ;
    LoadImage( cusRadioButtonUnChecked ) ;
    LoadImage( cusCheckBoxCheckedDisabled      ) ;
    LoadImage( cusCheckBoxUnCheckedDisabled    ) ;
    LoadImage( cusRadioButtonCheckedDisabled   ) ;
    LoadImage( cusRadioButtonUnCheckedDisabled ) ;
  end ;
...
procedure TtiListViewListBox.DoOnGetImageIndex(pData: TPersistent;
...
function TtiListViewListBox.GetIsSelected( pData: TPersistent ) : boolean ;
var
  lbResult : boolean ;
begin
  if ( pData <> nil ) and
