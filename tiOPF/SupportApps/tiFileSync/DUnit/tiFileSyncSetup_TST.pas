...
begin
  ...
  try
    ...
    try
      ...
      gTIPerMgr.InsertRow( cTableNameFileNameFilter, lParams ) ;
    finally
      lParams.Free ;
    end;
  finally
...
begin
  ...
  try
    ...
    try
      ...
      gTIPerMgr.InsertRow( cTableNameSyncDir, lParams ) ;
    finally
      lParams.Free ;
    end;
  finally
...
begin
  inherited;
  gTIPerMgr.DeleteRow( cTableNameSyncDir, nil ) ;
  gTIPerMgr.DeleteRow( cTableNameFileNameFilter, nil ) ;
end;
