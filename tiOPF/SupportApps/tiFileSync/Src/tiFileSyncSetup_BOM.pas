...
type
  ...
  TtiFileSyncSetup = class( TPerObjAbs )
  private
  ...
  //----------------------------------------------------------------------------
  TtiFileSyncDirs = class( TPerObjList )
  private
  protected
  ...
  //----------------------------------------------------------------------------
  TtiFileSyncDir = class( TPerObjAbs )
  private
  ...
  //----------------------------------------------------------------------------
  TtiFileNameFilter = class( TPerObjAbs )
  private
    FWildCard: TFileName;
...
procedure RegisterMappings ;
begin
  gTIPerMgr.ClassDBMappingMgr.RegisterMapping( TtiFileSyncDir, 'Sync_Dir', 'OID',            'OID', [pktDB]    ) ;
  gTIPerMgr.ClassDBMappingMgr.RegisterMapping( TtiFileSyncDir, 'Sync_Dir', 'LocalDir',       'Local_Dir'       ) ;
  gTIPerMgr.ClassDBMappingMgr.RegisterMapping( TtiFileSyncDir, 'Sync_Dir', 'TargetLocation', 'Target_Location' ) ;
  gTIPerMgr.ClassDBMappingMgr.RegisterMapping( TtiFileSyncDir, 'Sync_Dir', 'SourceReader',   'Source_Reader'   ) ;
  gTIPerMgr.ClassDBMappingMgr.RegisterMapping( TtiFileSyncDir, 'Sync_Dir', 'TargetReader',   'Target_Reader'   ) ;
  gTIPerMgr.ClassDBMappingMgr.RegisterCollection( TtiFileSyncDirs, TtiFileSyncDir  ) ;

  gTIPerMgr.ClassDBMappingMgr.RegisterMapping( TtiFileNameFilter, 'File_Name_Filter', 'OID', 'OID', [pktDB] ) ;
  gTIPerMgr.ClassDBMappingMgr.RegisterMapping( TtiFileNameFilter, 'File_Name_Filter', 'FilterTypeAsString', 'Filter_Type'   ) ;
  gTIPerMgr.ClassDBMappingMgr.RegisterMapping( TtiFileNameFilter, 'File_Name_Filter', 'WildCard', 'Wild_Card' ) ;
  gTIPerMgr.ClassDBMappingMgr.RegisterCollection( TtiFileNameFilters, TtiFileNameFilter  ) ;
end;
...
procedure TtiFileSyncSetup.AssignClassProps(pSource: TPerObjAbs);
begin
