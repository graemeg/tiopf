...
Uses
  ...
  ExtCtrls, StdCtrls, ActnList, tiVTListView;
...
Type
  ...
  Public
    FStoredObj : TPersistent;
    Property Filters : TList Read FFilters Write FFilters;
    Class Function EditFilter(pObject : TPersistent; pFilters : TList) : Boolean;
  End;
...
Class Function TfrmLVFilter.EditFilter(pObject : TPersistent; pFilters : TList) : Boolean;
Var
...
Begin
  (Sender As TAction).Enabled := ((cmbProperties.Text <> '') And (edValue.Text <> ''));
End;
