...
begin
  ...
  if gPerFrameworkSetupFactory.ToRun( cTIPersistSQLite ) then
    tiPerFrameworkSQLite_TST.RegisterTests ;
...
//    uPerFrameworkSetupFactory.Add( TPerFrameworkSetupRemote.Create  ) ;
    ...
    uPerFrameworkSetupFactory.Add( TPerFrameworkSetupSQLite.Create ) ;
  end ;
...
begin
  ...
  if gPerFrameworkSetupFactory.ToRun( cTIPersistSQLite ) then
    RegisterTest( pTestName, TTestDBConnectionSetupSQLite.Create( pTestCaseClass.Suite ) );
