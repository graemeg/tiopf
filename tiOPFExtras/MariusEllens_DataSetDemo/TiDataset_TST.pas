...
uses
  TestFramework, tiPtnVisPerObj, tiDataset, Db, Variants, SysUtils;
...
type
  TtiDatasetItem = class(TPerObjAbs)
  private
    FIntField: integer;
    FFloatField: Double;
    FStrField: string;
...
initialization
  Testframework.RegisterTest(TTestTiDataset.suite);
