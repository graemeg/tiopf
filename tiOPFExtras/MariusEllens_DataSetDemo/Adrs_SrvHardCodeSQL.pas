...
initialization
  ...
  // Read PK visitors
//  gTIPerMgr.RegReadPKVisitor( TVisCompanyRead_PK ) ;
//  gTIPerMgr.RegReadPKVisitor( TVisPersonRead_PK ) ;
//  gTIPerMgr.RegReadPKVisitor( TVisCompanyEmployeeRead_PK ) ;

  // Read detail visitors
  gTIPerMgr.RegReadVisitor( TVisLookupListRead ) ;
  ...
  // Delete visitors
  gTIPerMgr.RegSaveVisitor( TVisEAdrsDelete ) ;
  gTIPerMgr.RegSaveVisitor( TVisAdrsDelete ) ;
  gTIPerMgr.RegSaveVisitor( TVisPersonDelete ) ;
  gTIPerMgr.RegSaveVisitor( TVisCompanyDelete ) ;

  // Update visitors
  gTIPerMgr.RegSaveVisitor( TVisCompanyUpdate ) ;
  gTIPerMgr.RegSaveVisitor( TVisPersonUpdate ) ;
  gTIPerMgr.RegSaveVisitor( TVisEAdrsUpdate ) ;
  gTIPerMgr.RegSaveVisitor( TVisAdrsUpdate ) ;

  // Create visitors
  gTIPerMgr.RegSaveVisitor( TVisCompanyCreate ) ;
  gTIPerMgr.RegSaveVisitor( TVisPersonCreate ) ;
  gTIPerMgr.RegSaveVisitor( TVisEAdrsCreate ) ;
  gTIPerMgr.RegSaveVisitor( TVisAdrsCreate ) ;

  // List clean up visitors
  gTIPerMgr.RegSaveVisitor( TVisPersonListObjectStateDeleted   ) ;
  gTIPerMgr.RegSaveVisitor( TVisAddressListObjectStateDeleted  ) ;
  gTIPerMgr.RegSaveVisitor( TVisEAddressListObjectStateDeleted ) ;
